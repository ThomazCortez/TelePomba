...
<body>
    ...
    <main class="content-container">
        <h1 class="animate__animated animate__fadeInDown">Termos de Serviço</h1>
        ...
        <div class="animate__animated animate__fadeInRight animate-entrance">
            ...
            <p>O utilizador compromete-se a não utilizar os nossos serviços para atividades ilegais e a manter a confidencialidade da sua conta. Qualquer utilização indevida resultará no encerramento da conta do mesmo.</p>
        </div>

        <div class="animate__animated animate__fadeInLeft animate-entrance">
            <h2>3. Propriedade Intelectual</h2>
            <p>Todos os direitos sobre o conteúdo e software do TelePomba estão reservados.</p>
        </div>

        <div class="animate__animated animate__fadeInRight animate-entrance">
            <h2>4. Limitação de Responsabilidade</h2>
            <p>Não nos responsabilizamos por danos indiretos ou consequenciais decorrentes da utilização dos nossos serviços.</p>
        </div>
